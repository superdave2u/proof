...
- **Quest**:
  - Find a sunset you can watch from a comfortable, accessible place.
  - Choose one nonurgent task that can wait and deliberately stop it before it is finished.
  - Watch the light change. Let being there matter even if the sky never becomes spectacular.
- **Proof of Life**: Keep one photograph of the last light.
- **Special Stretch**: **Stay for Blue:** If time and comfort allow, remain after the obvious finale. Let the quieter light have your attention too.
...
- **Type**: Invitation • Creation
- **Quest**:
  - Arrange a few things you already own where you will see them.
  - Move a lamp or turn an object until something about the arrangement pleases you.
  - Leave it for your own company.
- **Proof of Life**: Photograph it; keep the photograph as the artifact.
- **Special Stretch**: **The Odd Companion:** Add one ordinary object you would not usually consider decorative and find a place for it.
...
- **Type**: Invitation • Creation
- **Quest**:
  - Choose something you have stopped using because a flaw embarrasses or disappoints you.
  - Make a safe, usable repair yourself or with help. Let the repair show; it need not look skillful.
  - Bring the thing back into ordinary use before you feel ready to call it beautiful.
- **Proof of Life**: Photograph the repaired thing in use.
- **Special Stretch**: **No Defense:** If someone notices, try: "I wanted to keep it." Let that be enough without criticizing your workmanship.
